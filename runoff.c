...
{
    // TODO
    int nbr_candidate_min = 0;
    int non_eliminated_candidate = 0;
    for (int i = 0 ; i < candidate_count ; i++)
    {
        if (candidates[i].eliminated == false)
        {
            non_eliminated_candidate++;
        }
    }
    for (int i = 0 ; i < candidate_count ; i++)
    {
    ...
    if (nbr_candidate_min == non_eliminated_candidate)
    {
        return true;
    }
    return false;
